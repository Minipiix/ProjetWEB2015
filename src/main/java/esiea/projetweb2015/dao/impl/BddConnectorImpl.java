...
public class BddConnectorImpl implements BddConnector{
	...
	public void initDatabaseData() {
    	articleDao.saveArticle(1, DIABLO, "<p>Cela faisait longtemps, Nephalem. Mon maître est plus dangereux que jamais, et hante éternellement la forteresse de Pandémonium, bien au-delà des limites de votre petite campagne. Mais il est distrayant de vous regarder vous débattre contre le chaos et la destruction qui envahissent Sanctuaire. Des horreurs continuent à surgir d’endroits depuis longtemps oubliés, et votre insatiable curiosité vous rapproche sans cesse de la fin. Accordez-moi le plaisir de vous montrer le chemin.</p> ", "<h3>ÊTES-VOUS PRÊT POUR LA 2.3 ?</h3>", "Nevalistis", new Date(2015, 8, 18));
    	articleDao.saveArticle(2, DIABLO, "<p>La mise à jour 2.3.0 approche à grands pas avec nombre d’enthousiasmantes nouveautés pour Diablo III. Alors que vous avez été nombreux à nous faire part de votre impatience de les découvrir, nous avons remarqué des questions fort pertinentes concernant ce qui vous attend avec la saison 4, auxquelles nous allons répondre dans le présent guide.Comme les précédentes, la saison 4 donnera accès à des objets légendaires, récompenses ornementales et effets de transmogrification saisonniers exclusifs. Nous allons en présenter certains ci-dessous, sans oublier la SPLEEENDIDE nouvelle interface de suivi de la saison : le périple. Accrochez-vous bien, voilà ce que vous réserve la saison 4 !</p>", "<h3>APERÇU DE LA SAISON 4</h3>", "Tyvalir ", new Date(2015, 8, 11));
